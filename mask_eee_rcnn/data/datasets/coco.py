...
from mask_eee_rcnn.structures import BoxMode, PolygonMasks, Boxes
...
def load_coco_json(json_file, image_root, dataset_name=None, extra_annotation_keys=None):
    ...
    if dataset_name is not None:
        ...
        if '_class1' in dataset_name:
            cat_ids = [1]
            cats = [{'supercategory': 'foreground', 'id': 1, 'name': 'foreground'}]
...
"""
    ...
    for (img_dict, anno_dict_list) in imgs_anns:
        ...
        for anno in anno_dict_list:
            ...
            if '_class1' in dataset_name:
                if 'armbench' in dataset_name:
                    if obj["category_id"] == 1:
                        continue
                    else:
                        obj["category_id"] = id_map[1]
                else:
                    obj["category_id"] = id_map[1]
            elif id_map:
...
if __name__ == "__main__":
    ...
    import mask_eee_rcnn.data.datasets  # noqa # add pre-defined metadata
    import sys
