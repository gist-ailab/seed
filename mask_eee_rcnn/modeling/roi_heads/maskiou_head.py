...
from mask_eee_rcnn.layers import Conv2d, ShapeSpec, cat, get_norm
...
class MaskIoUHead(nn.Module):
    def __init__(self, cfg):
        ...
        self.maskiou_fcn2 = Conv2d(256, 256, 3, 2, 1) 
        self.maskiou_fcn3 = Conv2d(256, 256, 3, 2, 1) 
        self.maskiou_fcn4 = Conv2d(256, 256, 3, 2, 1) 
        self.maskiou_fc1 = nn.Linear(256*2*2, 1024)
